...
export const GetFootballGamesRequestMeta: Record<keyof GetFootballGamesRequest, ParamMetadata> = {
  ...
  withExternalIds: { location: 'query', apiName: 'withExternalIds', required: false },
};
 ...
 */
export const GetFootballBoxScoreRequestMeta: Record<keyof GetFootballBoxScoreRequest, ParamMetadata> = {
 ...
 */
export const GetPlayByPlayRequestMeta: Record<keyof GetPlayByPlayRequest, ParamMetadata> = {
  gameId: { location: 'path', apiName: 'gameId', required: true },
  includePenalties: { location: 'query', apiName: 'includePenalties', required: false },
  includeFormations: { location: 'query', apiName: 'includeFormations', required: false },
};
 ...
 */
export const GetLiveGameStatsRequestMeta: Record<keyof GetLiveGameStatsRequest, ParamMetadata> = {
 ...
 */
export const GetWeeklyGameDetailsRequestMeta: Record<keyof GetWeeklyGameDetailsRequest, ParamMetadata> = {
  season: { location: 'query', apiName: 'season', required: true },
  type: { location: 'query', apiName: 'type', required: true },
  week: { location: 'query', apiName: 'week', required: true },
  includeDriveChart: { location: 'query', apiName: 'includeDriveChart', required: false },
  includeReplays: { location: 'query', apiName: 'includeReplays', required: false },
  includeStandings: { location: 'query', apiName: 'includeStandings', required: false },
  includeTaggedVideos: { location: 'query', apiName: 'includeTaggedVideos', required: false },
};
 ...
 */
export const GetStandingsRequestMeta: Record<keyof GetStandingsRequest, ParamMetadata> = {
  season: { location: 'path', apiName: 'season', required: true },
  seasonType: { location: 'path', apiName: 'seasonType', required: true },
  week: { location: 'path', apiName: 'week', required: true },
};
 ...
 */
export const GetRostersRequestMeta: Record<keyof GetRostersRequest, ParamMetadata> = {
  season: { location: 'path', apiName: 'season', required: true },
 ...
 */
export const GetPassingStatsRequestMeta: Record<keyof GetPassingStatsRequest, ParamMetadata> = {
  season: { location: 'query', apiName: 'season', required: true },
  seasonType: { location: 'query', apiName: 'seasonType', required: true },
 ...
 */
export const GetPlayerRequestMeta: Record<keyof GetPlayerRequest, ParamMetadata> = {
