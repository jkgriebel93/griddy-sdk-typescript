...
This TypeScript SDK is a port of the Python `griddy-sdk-python` package. See [PYTHON_VS_TYPESCRIPT_PATTERNS.md](_media/PYTHON_VS_TYPESCRIPT_PATTERNS.md) for details on the differences between the two implementations.
